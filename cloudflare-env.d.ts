/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: fecb9a5a2cd5711b5dd78d4074f2b00c)
// Runtime types generated with workerd@1.20250712.0 2025-07-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		APP_URL: "https://cc-vault.ayasnppk00.workers.dev" | "https://cc-vault-staging.ayasnppk00.workers.dev";
		NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "NEXTJS_ENV" | "QIITA_ACCESS_TOKEN">> {}
}
