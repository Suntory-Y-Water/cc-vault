        ...
        >
          <section>
            ...
            <p className='text-[var(--ai-text)] opacity-80 leading-relaxed'>
              ...
              （以下「当サービス」といいます。）は、ユーザーの個人情報の重要性を認識し、個人情報の保護に関する法律（個人情報保護法）を遵守し、適切な取り扱いを実施いたします。
            </p>
          </section>
          ...
          <section>
            ...
            <div className='space-y-4'>
              <div>
                <h3 className='text-lg font-semibold text-[var(--ai-text)] mb-2'>
                  2.1 アクセス情報
                </h3>
          ...
          <section>
            ...
            <p className='text-[var(--ai-text)] opacity-80 leading-relaxed mt-4'>
