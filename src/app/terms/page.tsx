        ...
        <div className='bg-white/50 rounded-lg p-8 space-y-8'>
          <section>
            ...
            <p className='text-[#141413] opacity-80 leading-relaxed'>
              本利用規約（以下「本規約」といいます。）は、CC-Vault（以下「当サービス」といいます。）の利用に関する条件を定めるものです。ユーザーの皆さま（以下「ユーザー」といいます。）には、本規約に従って、当サービスをご利用いただきます。
            </p>
          </section>
          ...
          <section>
            ...
            <ul className='list-disc list-inside space-y-2 text-[#141413] opacity-80 mt-4'>
              <li>
